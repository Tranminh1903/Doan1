...
<style>
    body, html {
        ...
        width: 100%;
        margin: 0;
        /* Đặt nền gốc đồng bộ với nền contact-wrapper */
        background: #020617 !important; 
    }

    /* NỀN FULL MÀU ĐỒNG BỘ VỚI TRANG ĐẶT VÉ */
    .contact-wrapper {
        min-height: 100vh;
        width: 100%;
        padding: 60px 0;
        /* Áp dụng gradient lên wrapper để tạo hiệu ứng */
        background:
            ...
            #020617; /* Màu nền chính (xanh đen) */
        color: #e5e7eb;
        font-family: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
    }

    /* Container căn giữa, giữ layout cũ */
    .contact-container {
        max-width: 1140px;
    }
    ...
    /* Chữ in đậm không phải link */
    .contact-wrapper p span {
        color: #dce3ea !important;
        font-weight: 600;
    }

    /* HÀNG CỘT BẰNG CHIỀU CAO */
    .contact-container .row {
        align-items: stretch;
    }

    /* GLASS CARD: 2 cột chính */
    .contact-info,
    .map-container {
    ...
    .map-container {
        height: 100%;
        min-height: 400px;
        padding: 0; /* Nội dung iframe không cần padding */
        overflow: hidden;
    }
    ...
    .map-container iframe {
        ...
        height: 100%;
        min-height: 400px;
        /* Bo góc bên trong Glass Card */
        border-radius: 0.9rem; 
        /* Border nhẹ để nổi bật iframe bên trong */
        border: 1px solid rgba(148, 163, 184, 0.4); 
    }
        ...
        <div class="row gx-4"> 
            ...
            <div class="col-md-5">
                <div class="contact-info">
                    ...
                    <p>Mail hỗ trợ: <a href="mailto:tranminh19304@gmail.com">tranminh19304@gmail.com</a></p>
                    
                    <h5>LIÊN HỆ QUẢNG CÁO, TỔ CHỨC SỰ KIỆN, THUÊ RẠP</h5>
                    <p>Phòng dịch vụ</p>
                    <p>Hotline: 0869083789</p>
                    <p>Mail: <a href="mailto:huynhduyman2005tvc@gmail.com">huynhduyman2005tvc@gmail.com</a></p>

                    <h5>LIÊN HỆ MUA VÉ HỢP ĐỒNG</h5>
                    <p>Phòng Chiếu Phim và Trung tâm Dịch vụ Điện ảnh</p>
                    <p>Hotline: 0869083581</p>
                    <p>Email: <a href="mailto:tuitendu@gmail.com">tuitendu@gmail.com</a></p>
                </div>
            </div>
