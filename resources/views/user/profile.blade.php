                        ...
                        <div class="tab-pane fade show active" id="tab-general" role="tabpanel" aria-labelledby="link-general">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p class="mb-1"><i class="bi bi-wallet2 me-2"></i>Tổng tiêu dùng: {{ number_format($totalAmount, 0, ',', '.') }} VND</p>
                                    <p class="mb-1"><i class="bi bi-receipt me-2"></i>Tổng đơn hàng: {{$total_order_amount }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><i class="bi bi-envelope me-2"></i>Email: {{ optional($customer->user)->email ?? 'chưa cập nhật' }}</p>
                                    <p class="mb-1"><i class="bi bi-telephone me-2"></i>Số điện thoại: {{ optional($customer->user)->phone ?? 'chưa cập nhật' }}</p>
                                    <p class="mb-1"><i class="bi bi-gender-ambiguous me-2"></i>Giới tính: {{ optional($customer->user)->sex ?? 'chưa cập nhật' }}</p>
                                    <p class="mb-1"><i class="bi bi-calendar-date me-2"></i>Ngày sinh: {{ optional($customer->user)->birthday ?? 'chưa cập nhật' }}</p>
                                    <p><strong>Ngày tạo tài khoản:</strong> {{ optional($customer->user->created_at)->format('d/m/Y') }}</p>
